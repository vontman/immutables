...
public class TreeTest {
    ...
    public void flatMap() throws Exception {
        ...
        final Tree<Integer> newTree = tree.flatMap(e ->
                Tree.of(IntStream.range(1, e + 1).map(x -> e).boxed().toArray(Integer[]::new)));
        assertEquals(6, newTree.size());
        assertEquals(Arrays.asList(1, 2, 2, 3, 3, 3), newTree.toList());
    }
    ...
    public void foreach() throws Exception {
        ...
        assertEquals(Arrays.asList("2", "1", "3"), console.buffer);
    }
